...
class _LeaveScreenState extends State<LeaveScreenManager>
  ...
  late Future<List<CompOffRequest>> _getOwncompOffRequest;
  ...
  void initState() {
    ...
    _getOwncompOffRequest = fetchOwnCompOffRequest('');
                          ...
                          tabs: [
                            Tab(
                              child: Row(
                                ...
                                children: [Icon(Icons.person), Text('Leaves')],
                              ),
                              // text: 'Self',
                            ),
                            Tab(
