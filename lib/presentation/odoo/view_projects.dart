                            ...
                            Column(    crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              children: [
                                ...
                                FlutterImageStack.widgets(
                                  children: [
                                    for (var n = 0;
                                        n < widget.alreadyAssignedEmails.length;
                                        n++)
                                      CircleAvatar(
                                        backgroundColor:
                                            Color.fromARGB(255, 235, 244, 254),
                                        child: Text(
                                          widget.alreadyAssignedEmails[n][0]
                                              .toUpperCase(), // Display first letter
                                          style: TextStyle(
                                  ...
                                  totalCount:
                                      widget.alreadyAssignedEmails.length,
                                  itemRadius: 30,
                                  itemBorderWidth: 2,
                                ),
                              ],
